...
@main.route('/')
def index():
    adventures = Blog.get_blogs('Adventures')
    health = Blog.get_blogs('health')
    technology = Blog.get_blogs('technology')
    cuisine = Blog.get_blogs('cuisine')

    return render_template('index.html', title = 'Blog Ma Intrests - Home', cuisine = cuisine, adventures = adventures, health = health, technology = technology)
...
@main.route('/blogs/adventures')
def adventures():
    blogs = Blog.get_blogs('adventures')

    return render_template('adventures.html',blogs = blogs)
